...
def ai_stuff():
    ...
    print(false_toothbrush_tips)
    print(false_laundry_tips)
    print(random_handwashing_tip)
    print(random_false_toothbrush_tip)
    print(random_false_laundry_tip)
    print(random_false_handwashing_tip)
    #return [random_false_toothbrush_tip,random_toothbrush_tip],[random_laundry_tip,random_false_laundry_tip],[random_handwashing_tip,random_false_handwashing_tip]
